package io.github.bananamod.entity.ai;
...
public class GorillaAttackGoal extends MeleeAttackGoal{
	...
	public GorillaAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
		super(mob, speed, pauseWhenMobIdle);
		entity = ((GorillaEntity) mob);
	}
    ...
    public void tick() {
        ...
        if(isTimeToPound()) {
        	entity.setPounding(true);
        } else {
        	entity.setPounding(false);
        }
