...
public class ItemInit {
	...
	public static final Item BANANA_PICKAXE = registerItem("banana_pickaxe", new SwordItem(BasisToolMaterial.BANANA, -2, -2.4F, new FabricItemSettings()));
	public static final Item BANANA_AXE = registerItem("banana_axe", new SwordItem(BasisToolMaterial.BANANA, 2, -1.5F, new FabricItemSettings()));
	public static final Item BANANA_SHOVEL = registerItem("banana_shovel", new SwordItem(BasisToolMaterial.BANANA, 4, -2.9F, new FabricItemSettings()));
	public static final Item BANANA_HOE = registerItem("banana_hoe", new SwordItem(BasisToolMaterial.BANANA, -2, -2.5F, new FabricItemSettings()));
